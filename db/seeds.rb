...
# People
Person.create(nin: 11111111, first_name: 'Uno', last_name: 'Primero', display_name: 'Uno Primero', avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))
Person.create(nin: 22222222, first_name: 'Dos', last_name: 'Segundo', display_name: nil, avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))
Person.create(nin: 33333333, first_name: 'Tres', last_name: 'Tercero', display_name: nil, avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))
Person.create(nin: 44444444, first_name: 'Cuatro', last_name: 'Cuarto', display_name: nil, avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))
Person.create(nin: 55555555, first_name: 'Cinco', last_name: 'Quinto', display_name: nil, avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))
Person.create(nin: 66666666, first_name: 'Seis', last_name: 'Sexto', display_name: nil, avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))
Person.create(nin: 77777777, first_name: 'Siete', last_name: 'Séptimo', display_name: nil, avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))
Person.create(nin: 88888888, first_name: 'Ocho', last_name: 'Octavo', display_name: nil, avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))
Person.create(nin: 99999999, first_name: 'Nueve', last_name: 'Noveno', display_name: nil, avatar_url: nil, birth_date: '1980-01-01', birth_commune: Commune.find_by(name: 'Concepción'))

# Baptisms
priest = Priest.find(1)
baptised = Person.find_by(nin: 11111111)
mother = Person.find_by(nin: 22222222)
father = Person.find_by(nin: 33333333)
godmother = Person.find_by(nin: 44444444)
godfather = Person.find_by(nin: 55555555)
...
baptised = Person.find_by(nin: 77777777)
mother = Person.find_by(nin: 22222222)
father = Person.find_by(nin: 33333333)
godmother = Person.find_by(nin: 88888888)
godfather = Person.find_by(nin: 99999999)
Baptism.create(priest: priest, baptised: baptised, mother: mother, father: father, godfather: godfather, godmother: godmother, date: Date.current)
